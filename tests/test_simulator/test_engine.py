...
class TestPQCImpact:
    ...
    def test_larger_signatures_increase_propagation(self, base_config):
        ...
        # ML-DSA-65 has larger signatures, should have longer propagation
        # (due to larger block sizes and slower verification)
        # Note: This may not always hold with small networks and short simulations
        # but should generally be true
        assert mldsa_result.avg_block_size_bytes > ed25519_result.avg_block_size_bytes
